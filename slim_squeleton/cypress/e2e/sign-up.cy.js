describe("Sign up", () => {
    ...
    it("[SU-8] shows error when the number of coins is below the limit", () => {
        ...
        cy.get(`[data-cy="sign-up__wrongCoins"]`).invoke('text').should("eq", "Sorry, the number of LSCoins is either below or above the limits.");
    });
    ...
    it("[SU-10] shows error when the number of coins is alphanumeric", () => {
        ...
        cy.get(`[data-cy="sign-up__btn"]`).click();
        cy.get(`[data-cy="sign-up__wrongCoins"]`).should("exist");
        cy.get(`[data-cy="sign-up__wrongCoins"]`).invoke('text').should("eq", "The number of LSCoins is not a valid number.");
    });
